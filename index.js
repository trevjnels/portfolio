...
const noPlaceLikeHome = function() {
  $(".left").html(
    `<div class="mission-summary"><h2 class="Summary">A repressed engineer formerally stuck in a enterprise-salesperson's life</h2><p>I am an obsessive and relentless tinkerer and have an unlimited thirst for new information with a strong appreciation for symmetry balance and natural patterns. I read thoroughly too much about the world and like to get caught up in the details. I am a mostly self-taught developer with an enterprise sales background. That said I was destined for engineering as child but was thrown off track. I had all the signs of a young steampunk Jedi: setting up the family computer at 5yo, becoming a mechanical pencil modder in 1st grade, spending much of my childhood solo in my dad’s workshop in the basement, and leading my physics/geometry/math classes without even trying.</p><p> As I got older, I became less focused on how to make my passion a career and ended up studying business as an undergrad. After the past 5 years of working hard without feeling that excited about my work, I realized I needed some sort of engineering in my work life. For about a year and a half now, I've been working on changing that by learning code. I have a passion for the web and I am a team player. I am fascinated by the ability to reach nearly the entire world with one deployment, and I am equally fascinated by the autonomous connections between computers that we can make and utilize to solve problems and connect the world. I am interested in development positions in the insurance world so that I can build upon my successes and knowledge base while learning more and more about the digital world while building it.When not coding, I'm summiting mountains and if(winter){c(snowboarding down them)}; .</p></div>`
  );
  $(".right")
